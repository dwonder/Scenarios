        ...
        <div className="bg-slate-800 rounded-xl border border-slate-700 p-2 sm:p-4">
            ...
            <div className="flex flex-col md:flex-row">
                <div className="md:w-3/4 p-4">
                    <h3 className="text-xl font-bold mb-4 text-slate-100">Phishing Challenge</h3>
                    <div className="text-slate-400 mb-6 text-sm space-y-2">
                      <p>Phishing is an attack where scammers try to trick you into revealing sensitive information. Your task is to identify and take the correct action on each email.</p>
                      <p>Common red flags to watch for:</p>
                      <ul className="list-disc list-inside text-xs space-y-1">
                          <li><strong className="font-semibold text-slate-300">Urgency:</strong> Creates panic to rush you into action (e.g., "account will be suspended").</li>
                          <li><strong className="font-semibold text-slate-300">Sender's Address:</strong> Look for misspellings or unusual domains (e.g., `support@a-mazon.co`).</li>
                          <li><strong className="font-semibold text-slate-300">Generic Greetings:</strong> Uses "Dear Customer" instead of your actual name.</li>
                          <li><strong className="font-semibold text-slate-300">Suspicious Links:</strong> Hover over links (don't click!) to see if the URL looks legitimate.</li>
                      </ul>
                    </div>
                ...
                <div className="md:w-1/4 p-4 bg-slate-900/50 rounded-lg flex flex-col">
                    <div className="flex-grow">
                        ...
                        <p className="text-slate-400 mb-6 text-sm text-center">Drag an email to an action.</p>
