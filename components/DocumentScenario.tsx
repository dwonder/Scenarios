    ...
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="lg:w-1/3 bg-slate-800 p-6 rounded-xl border border-slate-700 flex flex-col">
        <div className="flex-grow">
            ...
            <div className="text-slate-400 mb-6 text-sm space-y-3">
                <p>Correctly classifying documents is key to preventing data breaches. Drag each document to its corresponding storage location based on its sensitivity level.</p>
                <ul className="text-xs space-y-2">
                    <li><strong className="font-semibold text-slate-300">Public:</strong> Information cleared for public release (e.g., press releases, marketing). Can be stored in public folders.</li>
                    <li><strong className="font-semibold text-slate-300">Internal:</strong> For company-wide use. Disclosure wouldn't cause major harm but should be avoided (e.g., employee handbooks, team notes). Store on internal servers.</li>
                    <li><strong className="font-semibold text-slate-300">Confidential:</strong> Highly sensitive data. Unauthorized disclosure could cause serious damage (e.g., financial reports, client data). Must be kept in encrypted, secure storage.</li>
                </ul>
            </div>
